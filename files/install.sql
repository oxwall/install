...
INSERT INTO `%%TBL-PREFIX%%base_authorization_action` VALUES (7,5,'view',1),(8,5,'upload',0),(11,6,'add_comment',0),(13,5,'add_comment',0),(67,6,'search_users',1),(171,6,'view_profile',1),(303,130,'hide_ads',1),(330,144,'send_gift',0),(331,145,'add_to_list',0),(333,99,'read_chat_message',0),(334,99,'send_chat_message',0),(335,99,'reply_to_chat_message',0);
...
INSERT INTO `%%TBL-PREFIX%%base_authorization_moderator_permission` VALUES (1,1,5),(2,1,6),(3,1,140),(4,1,130),(5,1,144),(6,1,7),(13,1,7),(14,1,7),(15,1,7),(16,1,7),(17,1,7);
...
INSERT INTO `%%TBL-PREFIX%%base_authorization_permission` VALUES (3,7,1),(4,7,12),(5,7,34),(6,8,12),(7,8,34),(8,13,34),(13,67,1),(14,67,12),(15,67,34),(16,171,1),(17,171,12),(18,171,34),(19,303,34),(20,330,12),(21,330,34),(22,331,12),(23,331,34),(26,333,12),(27,333,34),(28,334,12),(29,334,34),(30,335,12),(31,335,34);
...
CREATE TABLE `%%TBL-PREFIX%%base_component_place` (
  ...
  KEY `componentId` (`componentId`)
) ENGINE=MyISAM AUTO_INCREMENT=100830 DEFAULT CHARSET=utf8 COMMENT='utf8_general_ci';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=11479 DEFAULT CHARSET=utf8 COMMENT='utf8_general_ci';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `%%TBL-PREFIX%%base_document` VALUES (3,'admin_pages','ADMIN_Pages','index',NULL,0,0),(23,'page-679283',NULL,NULL,'join',1,0),(39,'page-119658',NULL,NULL,'terms-of-use',1,0),(55,'page_99448870',NULL,NULL,'privacy-policy',1,0);
...
) ENGINE=MyISAM AUTO_INCREMENT=19423 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=MyISAM AUTO_INCREMENT=76190 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `%%TBL-PREFIX%%base_place` VALUES (1,'dashboard',0),(2,'index',0),(3,'profile',0),(4,'group',1),(5,'mobile.index',0),(6,'mobile.dashboard',0);
...
INSERT INTO `%%TBL-PREFIX%%base_plugin` VALUES (1,'Base OW plugin','Description','base','base','',1,1,NULL,NULL,1,0,NULL),(3,'Admin Panel','Admin Panel','admin','admin','',1,1,NULL,NULL,1,0,NULL),(804,'Advertisement','Simple banner ad management with geo-targeting','advertisement','ads','e547ebcf734341ec11911209d93a1054',0,1,'ads.admin_settings_index',NULL,8520,0,NULL),(800,'SkaDate System Tools','This is the backend service plugin for SkaDate. Do not deactivate or uninstall. This plugin must only be used for licensed SkaDate websites.','skadate','skadate','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'skadate.settigns','skadate.uninstall',8520,0,NULL),(812,'Hot List','Allows users to buy a place in the hot list with credits. This plugin must only to be used on licensed SkaDate websites.','hotlist','hotlist','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'hotlist-admin-settings',NULL,8520,0,NULL),(387,'User Credits','Allow users to earn, purchase and spend user credits','user_credits','usercredits','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'usercredits.admin',NULL,8520,0,NULL),(385,'PayPal Billing','Accept payments from users with PayPal payment provider','billing_paypal','billingpaypal','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'billing_paypal_admin',NULL,7700,0,NULL),(388,'Who Viewed Me','Displays guests visited user profile','ocs_guests','ocsguests','c36f83152f203c5a947a3fb053e4bc24',0,1,'ocsguests.admin',NULL,8520,0,NULL),(381,'Paid Membership','Customizable paid membership levels for accepting membership subscriptions','membership','membership','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'membership_admin',NULL,8300,0,NULL),(382,'Photo','Allow users to upload photos with tags, rates, and comments','photo','photo','e547ebcf734341ec11911209d93a1054',0,1,'photo_admin_config','photo_uninstall',8520,0,NULL),(378,'Google Maps Location','This plugin allows users to add their location in profile details.\n                 Plugin compatible with oxwall 1.7.1 only.','google_map_location','googlelocation','8697bdc9467df91a82092e3f1ffd199f',0,1,'googlelocation_admin',NULL,43,0,NULL),(376,'User Search','Implements quick and advanced search interfaces for dating sites. This plugin must only be used on licensed SkaDate websites.','usearch','usearch','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'usearch.admin_general_setting',NULL,8520,0,NULL),(374,'Messages','Unified messaging plugin for private on-site communication','mailbox','mailbox','e547ebcf734341ec11911209d93a1054',0,1,'mailbox_admin_config',NULL,8521,0,NULL),(810,'Matchmaking','Allows to calculate compatibility score between users based on profile information. You can modify the rules to change the matching algorithm. This plugin must only be used on licensed SkaDate websites.','matchmaking','matchmaking','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'matchmaking_admin_rules','matchmaking_uninstall',8521,0,NULL),(824,'Activity notifications','Real-time and email notifications about site activity','notifications','notifications','e547ebcf734341ec11911209d93a1054',0,1,NULL,NULL,8531,0,NULL),(825,'Virtual Gifts','Allow users to send private and public virtual gifts','virtual_gifts','virtualgifts','e547ebcf734341ec11911209d93a1054',0,1,'virtual_gifts_templates','virtual_gifts_uninstall',8520,0,NULL),(826,'Profile Cover Gallery','Shows a beautiful photo gallery on user profile. This plugin must only be used on licensed SkaDate websites.','pcgallery','pcgallery','99d6bdd5bb6468beaf118c4664dd92ff',0,1,NULL,NULL,8520,0,NULL),(827,'Bookmarks','Allow users to bookmark profiles for further contact. Help them never miss their match.','bookmarks','bookmarks','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'bookmarks.admin',NULL,2,0,NULL),(828,'Winks','Allow users to wink at each other to increase the number of contacts for monetization.','winks','winks','99d6bdd5bb6468beaf118c4664dd92ff',0,1,NULL,NULL,12,0,NULL),(829,'Google Analytics','Track your site visitor statistics with Google Analytics','google_analytics','ganalytics','e547ebcf734341ec11911209d93a1054',0,1,'ganalytics_admin',NULL,4600,0,NULL),(830,'Contact Us','\"Contact us\" page with the ability to choose departments (email addresses)','contactus','contactus','e547ebcf734341ec11911209d93a1054',0,1,'contactus.admin',NULL,3484,0,NULL),(833,'Premoderation','Moderation tools','moderation','moderation','99d6bdd5bb6468beaf118c4664dd92ff',0,1,'moderation.admin',NULL,8520,0,NULL);
...
INSERT INTO `%%TBL-PREFIX%%base_preference` VALUES (1,'mass_mailing_subscribe','true','general',1),(14,'mailbox_create_conversation_display_capcha','0','general',1),(13,'mailbox_create_conversation_stamp','0','general',1),(22,'im_user_settings_enable_sound','1','im',0),(24,'ajaxim_user_settings_enable_sound','1','ajaxim',0),(12,'newsfeed_generate_action_set_timestamp','0','general',10000),(15,'send_wellcome_letter','0','general',99),(25,'matchmaking_lastmatch_userid','0','matchmaking',0),(26,'profile_details_update_stamp','0','general',1),(27,'mailbox_user_settings_enable_sound','1','general',1),(28,'mailbox_user_settings_show_online_only','0','general',1),(29,'pcgallery_source','all','general',1),(30,'pcgallery_album','0','general',1);
...
INSERT INTO `%%TBL-PREFIX%%base_theme` VALUES (1550,'origin','Origin','{\"name\":\"Origin\",\"key\":\"origin\",\"version\":\"1.0\",\"compatibility\":\"1.5 and higher\",\"description\":\"The Origin theme\",\"author\":\"Oxwall Foundation\",\"authorEmail\":\"themes@oxwall.org\",\"authorUrl\":\"http:\\/\\/www.oxwall.org\\/foundation\",\"developerKey\":\"e547ebcf734341ec11911209d93a1054\",\"build\":\"8520\",\"copyright\":\"(C) 2012 Oxwall Foundation. All rights reserved.\",\"license\":\"The BSD License\",\"licenseUrl\":\"http:\\/\\/www.opensource.org\\/licenses\\/bsd-license.php\"}',0,NULL,NULL,NULL,'none','e547ebcf734341ec11911209d93a1054',8520,0,NULL),(1554,'trend','Trend','{\"name\":\"Trend\",\"key\":\"trend\",\"version\":\"1.0\",\"compatibility\":\"1.5 and higher\",\"description\":\"The original \\\"Trend\\\" theme for SkaDate Dating Software.\",\"author\":\"Skalfa\",\"authorEmail\":\"info@skalfa.com\",\"authorUrl\":\"http:\\/\\/www.skalfa.com\\/\",\"developerKey\":\"99d6bdd5bb6468beaf118c4664dd92ff\",\"build\":\"8520\",\"copyright\":\"(C) 2014 Skalfa LLC. All rights reserved.\",\"license\":\"SEL\",\"licenseUrl\":\"http:\\/\\/www.skadate.com\\/sel.pdf\",\"sidebarPosition\":\"right\"}',0,NULL,NULL,NULL,'right','99d6bdd5bb6468beaf118c4664dd92ff',8520,0,NULL),(1555,'tenderness','Tenderness','{\"name\":\"Tenderness\",\"key\":\"tenderness\",\"version\":\"1.0\",\"compatibility\":\"1.5 and higher\",\"description\":\"The original \\\"Tenderness\\\" theme for SkaDate Dating Software.\",\"author\":\"Skalfa\",\"authorEmail\":\"info@skalfa.com\",\"authorUrl\":\"http:\\/\\/www.skalfa.com\\/\",\"developerKey\":\"99d6bdd5bb6468beaf118c4664dd92ff\",\"build\":\"8520\",\"copyright\":\"(C) 2014 Skalfa LLC. All rights reserved.\",\"license\":\"SEL\",\"licenseUrl\":\"http:\\/\\/www.skadate.com\\/sel.pdf\",\"sidebarPosition\":\"right\"}',0,NULL,NULL,NULL,'right','99d6bdd5bb6468beaf118c4664dd92ff',8520,0,NULL),(1556,'gentle','Gentle','{\"name\":\"Gentle\",\"key\":\"gentle\",\"version\":\"1.0\",\"compatibility\":\"1.5 and higher\",\"description\":\"The original \\\"Gentle\\\" theme for SkaDate Dating Software.\",\"author\":\"Skalfa\",\"authorEmail\":\"info@skalfa.com\",\"authorUrl\":\"http:\\/\\/www.skalfa.com\\/\",\"developerKey\":\"99d6bdd5bb6468beaf118c4664dd92ff\",\"build\":\"8520\",\"copyright\":\"(C) 2014 Skalfa LLC. All rights reserved.\",\"license\":\"SEL\",\"licenseUrl\":\"http:\\/\\/www.skadate.com\\/sel.pdf\",\"sidebarPosition\":\"right\"}',0,NULL,NULL,NULL,'right','99d6bdd5bb6468beaf118c4664dd92ff',8520,0,NULL),(1558,'morning','Morning','{\"name\":\"Morning\",\"key\":\"morning\",\"version\":\"1.0\",\"compatibility\":\"1.5 and higher\",\"description\":\"The original \\\"Morning\\\" theme for SkaDate Dating Software.\",\"author\":\"Skalfa\",\"authorEmail\":\"info@skalfa.com\",\"authorUrl\":\"http:\\/\\/www.skalfa.com\\/\",\"developerKey\":\"99d6bdd5bb6468beaf118c4664dd92ff\",\"build\":\"8520\",\"copyright\":\"(C) 2014 Skalfa LLC. All rights reserved.\",\"license\":\"SEL\",\"licenseUrl\":\"http:\\/\\/www.skadate.com\\/sel.pdf\",\"sidebarPosition\":\"right\"}',0,NULL,NULL,NULL,'right','99d6bdd5bb6468beaf118c4664dd92ff',8520,0,NULL),(1559,'friends','Friends','{\"name\":\"Friends\",\"key\":\"friends\",\"version\":\"1.0\",\"compatibility\":\"1.5 and higher\",\"description\":\"The original \\\"Friends\\\" theme for SkaDate Dating Software.\",\"author\":\"Skalfa\",\"authorEmail\":\"info@skalfa.com\",\"authorUrl\":\"http:\\/\\/www.skalfa.com\\/\",\"developerKey\":\"99d6bdd5bb6468beaf118c4664dd92ff\",\"build\":\"8520\",\"copyright\":\"(C) 2014 Skalfa LLC. All rights reserved.\",\"license\":\"SEL\",\"licenseUrl\":\"http:\\/\\/www.skadate.com\\/sel.pdf\",\"sidebarPosition\":\"right\"}',0,NULL,NULL,NULL,'right','99d6bdd5bb6468beaf118c4664dd92ff',8520,0,NULL),(1560,'sweet','Sweet','{\"name\":\"Sweet\",\"key\":\"sweet\",\"version\":\"1.0\",\"compatibility\":\"1.5 and higher\",\"description\":\"The original \\\"Sweet\\\" theme for SkaDate Dating Software.\",\"author\":\"Skalfa\",\"authorEmail\":\"info@skalfa.com\",\"authorUrl\":\"http:\\/\\/www.skalfa.com\\/\",\"developerKey\":\"99d6bdd5bb6468beaf118c4664dd92ff\",\"build\":\"8520\",\"copyright\":\"(C) 2014 Skalfa LLC. All rights reserved.\",\"license\":\"SEL\",\"licenseUrl\":\"http:\\/\\/www.skadate.com\\/sel.pdf\",\"sidebarPosition\":\"right\"}',0,NULL,NULL,NULL,'right','99d6bdd5bb6468beaf118c4664dd92ff',8520,0,NULL);
...
INSERT INTO `%%TBL-PREFIX%%membership_plan` VALUES (1,1,19.000,30,1),(5,1,99.000,365,1),(4,1,49.000,90,1);
...
INSERT INTO `%%TBL-PREFIX%%usercredits_action` VALUES (1,'base','daily_login',0,NULL,1),(2,'base','user_join',0,NULL,1),(3,'base','search_users',0,NULL,1),(4,'base','add_comment',0,NULL,1),(5,'photo','add_photo',0,NULL,1),(6,'photo','add_comment',0,NULL,1),(7,'mailbox','send_message',0,NULL,1),(44,'hotlist','add_to_list',0,NULL,1),(45,'virtualgifts','template_1',1,NULL,1),(46,'virtualgifts','template_2',1,NULL,1),(47,'virtualgifts','template_3',1,NULL,1),(48,'virtualgifts','template_4',1,NULL,1),(49,'virtualgifts','template_5',1,NULL,1),(50,'virtualgifts','template_6',1,NULL,1),(51,'virtualgifts','template_7',1,NULL,1),(52,'virtualgifts','template_8',1,NULL,1),(53,'virtualgifts','template_9',1,NULL,1),(54,'virtualgifts','template_10',1,NULL,1),(55,'virtualgifts','template_11',1,NULL,1),(56,'virtualgifts','template_12',1,NULL,1),(57,'virtualgifts','template_13',1,NULL,1),(58,'virtualgifts','template_14',1,NULL,1),(59,'virtualgifts','template_15',1,NULL,1),(60,'mailbox','read_message',0,NULL,1);
...
INSERT INTO `%%TBL-PREFIX%%virtualgifts_template` VALUES (1,NULL,'jpg',1416991768,0),(2,NULL,'jpg',1416991768,0),(3,NULL,'jpg',1416991768,0),(4,NULL,'jpg',1416991768,0),(5,NULL,'jpg',1416991768,0),(6,NULL,'jpg',1416991768,0),(7,NULL,'jpg',1416991768,0),(8,NULL,'jpg',1416991768,0),(9,NULL,'jpg',1416991768,0),(10,NULL,'jpg',1416991768,0),(11,NULL,'jpg',1416991768,0),(12,NULL,'jpg',1416991768,0),(13,NULL,'jpg',1416991768,0),(14,NULL,'jpg',1416991768,0),(15,NULL,'jpg',1416991768,0);
...
-- Dump completed on 2014-11-26 14:49:30
